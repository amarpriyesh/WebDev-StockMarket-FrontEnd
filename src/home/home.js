...
const Home = () => {
    const text = 'MarketPulse is a cutting-edge web platform designed to provide users with ' +
        'real-time stock market news and insights. By leveraging the powerful APIs ' +
        'offered by MarketAux.com, MarketPulse aims to deliver up-to-the-minute financial ' +
        'data, expert analysis, and market trends to both individual investors and ' +
        'financial professionals. In addition, MarketPulse provides CRUD operations on user management,' +
    ...
    return (
        ...
        `}
            ...
            <div style={containerStyle}>
                <h1 style={titleStyle}>MarketPulse</h1>
